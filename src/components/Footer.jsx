      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Jahan University</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Shaping future leaders through excellence in education, research, and innovation since 1985.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/faculties" className="text-gray-300 hover:text-white transition-colors duration-200">Academic Programs</Link></li>
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Student Life</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Islamic Studies</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Business Admin</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Engineering</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Medicine</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Arts & Literature</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="text-gray-300 text-sm">
                <p>📍 Karte Naw 3th St, Kabul.</p>
                <p>📞 0777777777</p>
                <p>✉️ info@jahanuniversity.edu</p>
              </div>
              <div>
                ...
                <div className="flex">
                  ...
                  />
                  <button className="bg-primary-600 hover:bg-primary-700 px-4 py-2 rounded-r-md transition-colors duration-200">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 Jahan University. All rights reserved. | Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
